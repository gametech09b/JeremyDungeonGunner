...
public class MovementDetailsSO : ScriptableObject
{
    ...
    #region Tooltip
    [Tooltip("If there is a roll movement- this is the speed of the roll")]
    #endregion
    public float rollSpeed;
    #region Tooltip
    [Tooltip("If there is a roll movement- this is the distance of the roll")]
    #endregion
    public float rollDistance;
    #region Tooltip
    [Tooltip("If there is a roll movement- this is the cooldown time in seconds between the roll action")]
    #endregion
