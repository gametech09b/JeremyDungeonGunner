...
public class RoomNodeGraphEditor : EditorWindow
{
    ...
    private void ProcessMouseUpEvent(Event currentEvent)
    {
        ...
        if (currentEvent.button == 1 && currentRoomNodeGraph.roomNodeToDrawLineFrom != null)
        {
            ...
            if (roomNode != null)
            {
                // if so set it as child of the parent room node if it can be added
    ...
    /// <summary>
    /// Drag connectiong line from room node
    /// </summary>
    ...
    /// </summary>
    private void DrawConnectionLine(RoomNodeSO parrentRoomNode, RoomNodeSO childRoomNode)
    {
        // get line start and end position
        Vector2 startPosition = parrentRoomNode.rect.center;
        ...
        // calculate normalised prependicular position from the mid point
    ...
    {
        // loop through all room node and draw them
        foreach (RoomNodeSO roomNode in currentRoomNodeGraph.roomNodeList)
        {
